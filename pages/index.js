  ...
  return (
    <div className="min-h-screen flex-col flex justify-center items-center">
      <Head>
        ...
        <meta name="description" content="Dapp made by  Lakshay " />
      ...
      <footer className="fixed bottom-0 p-4 footer bg-base-100 border-t-2 border-base-200 text-base-content footer-center">
        <div>
          <p>
            Made with ❤️ by &nbsp;
            <a href="https://github.com" target="_blan">
              <span className="relative hover:underline font-bold cursor-pointer">
                Lakshay 
              </span>
            </a>
          </p>
